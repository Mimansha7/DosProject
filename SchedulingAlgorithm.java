...
public class SchedulingAlgorithm {
    ...
    static void findAvgTime(int processes[], int n, int burstTimes[], int quantum, int arrivalTimes[]) {
        ...
        // Compare the efficiency of algorithms based on average waiting
        // timecompareAlgorithmsEfficiency(total_wt /
        // n,calculateFCFSAvgWaitingTime(burstTimes, arrivalTimes));
    }
